import { GlobalResources, POIType, POIRarity, TerrainType } from './types';
...
// Icons are now string identifiers instead of React elements
...
export const ICON_SVG_PATHS: { [key: string]: string } = {
  ...
  biohazard: "M12.83,11.17,14,12.34V14a1,1,0,0,1-2,0V12.66l-1.17-1.17a3,3,0,0,1-1.66,0L8,12.66V14a1,1,0,0,1-2,0V12.34L7.17,11.17a3,3,0,0,1,0-4.34L6,5.66V4A1,1,0,0,1,8,4V5.34l1.17,1.17a3,3,0,0,1,1.66,0L12,5.34V4a1,1,0,0,1,2,0V5.66l1.17,1.17a3,3,0,0,1,0,4.34M12,2a10,10,0,1,0,10,10A10,10,0,0,0,12,2Zm0,5a1,1,0,1,0,1,1A1,1,0,0,0,12,7Z",
  spider: "M19,10a1,1,0,0,0-1,1,5,5,0,0,1-4,4.9V12h2a1,1,0,0,0,0-2H14V7h2a1,1,0,0,0,0-2H14V2a1,1,0,0,0-2,0V5H10V2a1,1,0,0,0-2,0V5H6a1,1,0,0,0,0,2H8v3H6a1,1,0,0,0,0,2H8v4.9A5,5,0,0,1,4,11a1,1,0,0,0-2,0,7,7,0,0,0,6,6.9V22a1,1,0,0,0,2,0V17.9a7,7,0,0,0,6-6.9,1,1,0,0,0-1-1Z",
  serpent: "M18.36,8.76a1,1,0,0,0-1.41,0L13,12.71V5a1,1,0,0,0-2,0v7.71L7.05,8.76a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.41l5.66,5.66a1,1,0,0,0,1.41,0l5.66-5.66A1,1,0,0,0,18.36,8.76Z",
  claw: "M20,17.18V5a3,3,0,0,0-3-3H7A3,3,0,0,0,4,5V17.18a3,3,0,0,0,1.24,2.45l.18.13,6,4.3a.49.49,0,0,0,.56,0l6-4.3.18-.13A3,3,0,0,0,20,17.18ZM8,10a1,1,0,1,1,1,1A1,1,0,0,1,8,10Zm4,0a1,1,0,1,1,1,1A1,1,0,0,1,12,10Zm4,0a1,1,0,1,1,1,1A1,1,0,0,1,16,10Z",
};
...
// CSS classes converted to a format that can be used by both server and client
